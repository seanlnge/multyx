 ...
 */
export declare function MergeRawObjects(target: RawObject, source: RawObject): RawObject<any>;
/**
 ...
 */
export declare function MapToObject<K, V>(target: Map<K, V>, key?: (c: K) => string, value?: (v: V) => any): RawObject;
export declare class EditWrapper<T = any> {
    data: T;
    constructor(data: T);
}
